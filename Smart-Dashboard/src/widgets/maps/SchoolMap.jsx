...
export function SchoolMap({ schools, loading }) {
  ...
  return (
    <div className="w-full flex flex-col gap-4">
      ...
      <div className="flex w-full gap-4">
        ...
        >
          <h4 className="text-center text-sm font-bold text-blue-gray-700 mb-2">
            Select Schools<hr/>
          </h4>
